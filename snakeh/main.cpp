...
int x,y,voceX,voceY,score;
int repN;
bool izgubio;
vector <string> hscore;
...
int drugimeni(){
    cout <<" _  ___ ____     ____    __  "<< endl;
 cout <<"| |/  / __  )   / _ |   | |  "<< endl;
 cout <<"| /  / |__) |  / /_||   | |  "<< endl;
 cout <<"|   {|  _  /  / __  |_  | |  "<< endl;
 cout <<"| |  | | | | / /  | | |_/ |  "<< endl;
 cout <<"|_||_|_|_|_|/_/___|_|____/   "<< endl;
 cout <<"|_   _/ ____|  __  )  ___|   "<< endl;
 cout <<"  | || |  __| |__) | |__     "<< endl;
 cout <<"  | || | |_ |  _  /|  __|    "<< endl;
 cout <<" _| || |__| | | | || |___    "<< endl;
...
void highscore(){
    ofstream fout;
    fout.open("highscore.txt",fstream::app);
    if(!fout)
        cout<<"nista od highscora";
    else
    fout<<score<<endl;
    fout.close();
    ifstream fin;
